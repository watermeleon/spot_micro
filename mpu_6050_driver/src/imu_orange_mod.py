...
class IMU:
    def __init__(self, rp_flip=True, r_neg=False, p_neg=True, y_neg=True, sensor_func = None):
    ...
    def read_imu(self):
        """
        """
        acc_vals, magn_vals, gyro_vals = self.sensor_func()
        accel_x, accel_y, accel_z = acc_vals
        mag_x, mag_y, mag_z = magn_vals
        gyro_x, gyro_y, gyro_z = gyro_vals
